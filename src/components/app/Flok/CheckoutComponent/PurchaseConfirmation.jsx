import { Box, Button, Divider, Flex, Img, Text, useDisclosure } from "@chakra-ui/react";
      ...
      <Box mt={{ base: "30px", lg: "94px" }}>
        ...
        >
          ...
          >
            ...
            <Box textAlign={{ base: "center", md: "", lg: "center" }}>
              <Button
                bg="black"
                colorScheme="black"
                color="white"
                p={{ base: "10px 20px", md: "10px 20px", lg: "30px 40px" }}
                borderRadius="40px"
              >
                Add to Calendar
              </Button>
