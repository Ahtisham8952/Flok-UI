...
const LabelBox = () => {
 ...
 <Box _hover={{textDecoration:'none'}} as={Link} href={li.refPage} key={index} bg="#FFFFFF" borderRadius={"5px"} maxW="270px" w="100%" py="11px" px={{base:'11px',md:'12px',xl:'7px',xxl:'15px'}} display={"flex"} alignItems="center" gap={{base:'12px',md:'14px',lg:'20px',xl:'24px',xxl:'32px',xxxl:'64px'}}>
