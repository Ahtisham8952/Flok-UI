...
const CustomInput = forwardRef<HTMLInputElement, CustomInputProps>(
  ({ value, onClick, onChange }, ref: ForwardedRef<HTMLInputElement>) => (
    <Input
      ...
      _focusVisible={'none' as SystemStyleObject}
      onClick={onClick}
      value={value}
      onChange={onChange}
      ref={ref}
...
const EventPageForm = () => {
  ...
  const [recurringUntil, setRecurringUntil] = useState<Date | null>();
  ...
  const onSubmit = async () => {
    try {
      ...
      if (date! > recurringUntil!) {
        ...
        let endDate = new Date(recurringUntil!);
      ...
      const createEventInput = {
        ...
        categoryIds: categories.map(
          (category: { value: string; label: string }) => category.value
        ),
      ...
      >
        <Box maxW={{ base: '100%', md: '50%' }} width="100%">
          ...
          <Flex align="center" justifyContent="space-between" my="50px">
            ...
            <Select
              ...
              onChange={(value) => setCategories(value as [])}
        ...
        <Box>
          ...
          <CheckboxGroup
            colorScheme="blue"
            value={options}
            onChange={(value) => setOptions(value as [])}
          >
        ...
        <Box>
          ...
          <CheckboxGroup
            value={languages}
            onChange={(value) => setLanguages(value as [])}
          >
