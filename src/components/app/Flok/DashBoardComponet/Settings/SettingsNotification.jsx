import { Box, Button, Flex, Image, Switch, Text, Textarea } from '@chakra-ui/react'
      ...
      Welcome, Richard Hederson
       ...
       New Movie Update
          ...
          <Text
            ...
            lineHeight={"16px"}
          >
       Provide movie updates at any time as well as a summary of news about the film.
          </Text>
            </Box>
            <Box>
        <Switch size='lg' />
      ...
      Notification Message
       ...
       Message
          ...
          <Text
            ...
            lineHeight={"16px"}
          >
      Helps provide a marker that there is a new message for the customer.
          </Text>
            </Box>
            <Box>
        <Switch size='lg' />
...
lineHeight={"16px"}
>
Helps provide a marker that there is a new email for the customer.
</Text>
</Box>
<Box>
<Switch size='lg' />
