...
function Sidebar({ onSelectTab }: { onSelectTab: Function }) {
        ...
        >
          ...
          <Box>
            ...
            <Text
              ...
              textAlign={'center'}
            >
              Having difficulty in Ticketing. Please contact us for further
              inquiries
            </Text>
              ...
              >
                ...
                <Box>
                  ...
                  <Text
                    ...
                    textAlign={'center'}
                  >
                    Having difficulty in Ticketing. Please contact us for
                    further inquiries
                  </Text>
                  <Flex justifyContent={'center'}>
                    <Button
...
function Content({ selectedTab }: { selectedTab: string }) {
  const getContent = () => {
    switch (selectedTab) {
      case 'Dashboard':
        return (
      ...
      // HERE...............................................................................................
      case 'Settings':
        return <Box id="Settings">Settings</Box>;
      case 'Basic Settings':
        return (
